            ...
            <div className="flex justify-center mb-10">
                <div className="bg-secondary shadow rounded-full p-1 flex gap-2">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full cursor-pointer transition ${!yearly ? "bg-primary text-white" : "text-gray-400"
                            }`}
                    >
                        Monthly
                    </button>
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
                {plans.map((plan, idx) => (
                    ...
                    >
                        ...
                        <button className="mt-auto bg-primary text-white py-2 rounded-xl hover:opacity-90 transition cursor-pointer ">
                            Subscribe Now
                        </button>
                    </div>
                ))}
