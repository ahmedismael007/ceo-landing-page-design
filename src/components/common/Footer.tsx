...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-[#997A00] to-[#FFCC00] pt-20 pb-5">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="px-4 py-6 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-white dark:text-gray-300 sm:text-center">© 2025 <a href="https://ceo-app.com/">CEO APP™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                        <a href="#" className="text-white hover: dark:hover:text-white">
