...
const Footer = () => {
    return (
        <footer className="bg-secondary pt-20 pb-5">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="px-4 py-6 bg-secondary md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a href="https://ceo-app.com/">CEO APP™</a>. All Rights Reserved.
                    </span>
